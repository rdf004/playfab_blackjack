...
class Game extends React.Component {
    ...
    componentDidMount() {
        ...
        PlayFabClient._internalSettings.sessionTicket = localStorage.getItem('_internalSettings');
        PlayFabClient._internalSettings.entityToken = localStorage.getItem('_internalSettings_entityToken');
    }
