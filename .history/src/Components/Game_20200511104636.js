...
class Game extends React.Component {
    ...
    render() {
        ...
        var my_hand_output = this.state.my_hand.map(item => {
            <li>{item}</li>
        })

        var dealer_hand_output = this.state.dealer_hand.map(item => {
            <li>{item}</li>
        })
        ...
        return (
            <div className="game-page">
                ...
                <div></div>
                    <h2>Dealer hand: {this.state.dealer_hand.map((item) => {
                        <p>{item}</p>
                    })}</h2>
                    <div></div>
                    <h2>My hand: {this.state.my_hand.map((item) => {
                        <p>{item}</p>
                    })}</h2>
                    <div></div>        
