...
class Game extends React.Component {
    ...
    calculate_winner = () => {
        var my_total = this.getDealerTotal();
        var dealer_total = this.getMyTotal();
        ...
        return (
            <div className="game-page">
                <div className="game-div">
                    <div></div>
                    <button className="blackjack-button" onClick={this.hit}>Stay</button>
                    <div></div>
                    <button className="blackjack-button" onClick={this.stay}>Hit</button>
                    <div></div>
                </div>
            </div>
        );
